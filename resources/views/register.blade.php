...
<body class="antialiased bg-bottom font-jetbrains bg-no-repeat bg-fixed" style="background-image: url('fondo.png')">
    <div class="sm:m-6 space-y-6">
        ...
        <form class="w-full max-w-3xl p-10 shadow-2xl m-auto bg-white" action="{{Route('register.store')}}" method="post">
            @csrf
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-1/2 px-3">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="correoElectronico">
                        Correo Electronico *
                    </label>
                    <input
                        ...
                        id="correoElectronico" name="correoElectronico" type="email" placeholder="example@mail.com">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        class="appearance-none block w-full text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white placeholder:text-violet-600"
                        id="apellidoPaterno" name="apellidoPaterno" type="text" placeholder="Apellido Paterno">
                </div>
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <input
                        class="appearance-none block w-full text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white placeholder:text-violet-600"
                        id="contraseña" name="contraseña" type="password" placeholder="Contraseña">
                </div>
            </div>
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        class="appearance-none block w-full text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white placeholder:text-violet-600"
                        id="apellidoMaterno" name="apellidoMaterno" type="text" placeholder="Apellido Materno">
                </div>
                <div class="w-full md:w-1/2 px-3">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                        for="contraseña_confirmation">
                        Confirmar contraseña *
                    </label>
                    <input
                        class="appearance-none block w-full text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white placeholder:text-violet-600"
                        id="contraseña_confirmation" name="contraseña_confirmation" type="password" placeholder="Contraseña">
                    @error('contraseña')
                    <p class="text-red-700">{{ $message }}</p>
                    @enderror
                </div>
