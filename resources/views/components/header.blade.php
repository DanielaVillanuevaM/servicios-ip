    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="items-center justify-between hidden w-full xl:flex xl:w-auto xl:order-1" id="navbar-sticky">
            <ul
                ...
                <li>
                    <a href="#"
                        class="block py-2 px-3 text-skin-base rounded hover:bg-[#794adb] xl:hover:bg-transparent xl:hover:underline xl:p-0 xl:pl-20">Inicio
                        de Sesión</a>
                </li>
                <li>
                    <a href="#"
                        class="block py-2 px-3 text-skin-base rounded hover:bg-[#794adb] xl:hover:bg-transparent xl:hover:underline xl:p-0">Registro</a>
                </li>
            </ul>
        </div>
    </div>
